...
~~There is relatively little difference in the temperatures of the uncomplicated patients.~~ <span style="color:blue">The range of the temperatures of the uncomplicated patients may seem small, but it's kind of large:</span> The lowest is $38.1 ^\circ \text{C}$, while the highest temperature is $39.7 ^\circ \text{C}$. <span style="color:green">This is a 2.88 degree F difference, which can be medically significant.</span>
